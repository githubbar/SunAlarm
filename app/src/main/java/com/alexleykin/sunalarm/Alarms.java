...
public class Alarms {
    ...
    public static final String ALARM_ALERT_ACTION = "com.alexleykin.sunalarm.ALARM_ALERT";
    ...
    public static final String ALARM_DONE_ACTION = "com.alexleykin.sunalarm.ALARM_DONE";
    ...
    public static final String ALARM_SNOOZE_ACTION = "com.alexleykin.sunalarm.ALARM_SNOOZE";

    // AlarmAlertFullScreen listens for this broadcast intent, so that other applications
    // can dismiss the alarm (after ALARM_ALERT_ACTION and before ALARM_DONE_ACTION).
    public static final String ALARM_DISMISS_ACTION = "com.alexleykin.sunalarm.ALARM_DISMISS";
...
//        ContentValues values = new ContentValues(8);
        ...
        values.put(Alarm.Columns.SUNRISE_DURATION, alarm.sunrise_duration);
        values.put(Alarm.Columns.SUNRISE_TURNOFF, alarm.sunrise_turnoff);
        return values;
    }
    ...
    static void saveNextAlarm(final Context context, String timeString) {
        // TODO: save it not in system settings!
        return;
